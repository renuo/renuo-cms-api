...
RSpec.describe 'routes for ContentBlocks', type: :routing do
  ...
  it 'routes the typical requests' do
    ...
    expect(get: '/api/content_blocks/apikey/1').to be_routable
    expect(put: '/api/content_blocks/apikey/1').to be_routable
    expect(delete: '/api/content_blocks/apikey/1').to be_routable
  end
